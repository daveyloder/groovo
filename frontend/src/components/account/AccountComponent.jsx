...
const AccountComponent = ({ toggle }) => {
    ...
    function handleCreateAccount() {
        ...
        let confirmPassword = account.confirmPassword = formInput["confirmPassword"].value;
  ...
  return (
    <Form id="account-form" className={styles.formContainer}>
      ...
      <FormGroup floating>
        <Input id="confirmPassword" name="confirmPassword" placeholder="confirmPassword" type="password"/>
        <Label for="password">Confirm Password</Label>
      </FormGroup>{" "}
      <Button className={styles.formButton} color="success" onClick={handleCreateAccount}>
        Submit
      </Button>
